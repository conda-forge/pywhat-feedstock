...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pywhat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12916&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pywhat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pywhat` can be installed with:

```
conda install pywhat
```

It is possible to list all of the versions of `pywhat` available on your platform with:
